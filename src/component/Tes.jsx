                ...
                <div className="w-[340px] sm:w-[500px] md:w-[600px] lg:w-[1100px] max-w-[1024px] mx-auto z-10 ">
                    <Slider{...settings}>
                        {dataTestimoni.map((item)=>(
                            <div className='mt-3 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 hover:shadow-orange/30  duration-300 p-10 rounded-2xl bg-white font-poppins text-[#777777] shadow-xl'>
